...
namespace WaterButt
{
    ...
    public class RainwaveClient
    {
        ...
        public const string sBaseURL = "http://rainwave.cc:20000/api4/";

        /// <summary>The User ID to use when communicating with the API. Find your User ID at: http://rainwave.cc:20000/keys/. </summary>
        private int iUserID = 0;

        /// <summary>The API key to use when communicating with the API. Find your API key at: http://rainwave.cc:20000/keys/. </summary>
        ...
        public string Call(string p_sPath, DynamicDictionary p_Args = null, bool p_bBeautify = false)
        {
            ...
            if (!p_sPath.ToLower().EndsWith("stations"))
            {
