    ...
    public class RainwaveChannel
    {
        ...
        public List<RainwaveAlbum> Albums
        {
            get
            {
                ...
                {
                    string sJSON = Client.Call("all_albums", oInitalArgs);
                    _Albums = Client.JSON.ToObject<List<RainwaveAlbum>>(Client.JSON.ToJSON(Client.JSON.ToDynamic(sJSON).all_albums));
        ...
        public List<RainwaveListener> Listeners
        {
            get
            {
                ...
                {
                    string sJSON = Client.Call("info", oInitalArgs);
        ...
        private dynamic _oInitalArgs = null;
        public dynamic oInitalArgs
        {
            get
            {
                if (_oInitalArgs == null)
                {
                    _oInitalArgs = new DynamicDictionary();
                    _oInitalArgs.sid = iID;
                }
                return _oInitalArgs;
            }
        }
        ...
        {
            dynamic oArgs = oInitalArgs;
            oArgs.album_id = p_iAlbumID;
            oArgs.fav = p_bFav;

            return Client.Call("fave_album", oArgs);
        }
        ...
        public string favSong(int p_iSongID, bool p_bFav)
        {
            ...
            return Client.Call("fave_song", oArgs);
        }
        ...
        private void DoAsyncRequestsGet()
        {
            ...
            _Requests = Client.JSON.ToObject<List<RainwaveUserRequest>>(Client.JSON.ToJSON(oJSON.requests));
            _RequestingUsers = Client.JSON.ToObject<List<RainwaveRequestingUser>>(Client.JSON.ToJSON(oJSON.request_line));
